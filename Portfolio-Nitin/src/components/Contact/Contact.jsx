  ...
  return (
    ...
    <div className='contact' id='contact'>
      ...
      <div className='contact-part'>
        ...
        <p><IoCall style={{marginTop:'2px'}} /><a href='/'>+91 9991918921</a></p>
          <p><HiOutlineMail style={{marginTop:'2px'}} /><a href="mailto:ni3deswal@gmail.com" target='_blank'>ni3deswal@gmail.com</a></p>
          <p><BsLinkedin style={{marginTop:'2px'}} /><a href="https://www.linkedin.com/in/nitin-deswal/" target='_blank'>https://www.linkedin.com/in/nitin-deswal/</a></p>
          <p><AiFillGithub style={{marginTop:'2px'}} /><a href="https://github.com/ni3deshwal/" target='_blank'>https://github.com/ni3deshwal</a></p>
        </div>
      </div>
